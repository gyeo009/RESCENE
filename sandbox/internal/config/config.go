...
type Config struct {
	...
	WorkspaceBaseDir string  // 호스트 상의 워크스페이스 루트 경로
...
func Load() *Config {
	...
	if runtime == "" {
		runtime = "runc" // 기본 런타임은 runc
	}

	workspaceBaseDir := os.Getenv("SANDBOX_WORKSPACE_BASE_DIR")
	if workspaceBaseDir == "" {
		workspaceBaseDir = "C:\\Users\\ran22\\Desktop\\project\\RESCENE\\sandbox\\tmp\\workspaces"
	}
	...
	var memoryLimit int64 = 512 * 1024 * 1024 // 기본 512MB
